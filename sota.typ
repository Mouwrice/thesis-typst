...
In this section, we will provide a brief overview of some recent body pose estimation tools and papers that have been published. Moreover, for every tool or paper, we will provide a short summary of the key features and limitations. As well as a brief comparison with the MediaPipe Pose tool that we will be using in this project and research.
